    ...
    return (<>
        <Container>
            <Box>
                ...
                <Typography variant="body1">As a side effect, We think that Content Creators could rapidly drive the mass adoption of Tokens and NFTs through their activities.</Typography>                    
            </Box>
        </Container>
    </>)
} 